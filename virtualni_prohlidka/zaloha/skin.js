function pano2vrSkin(player,skinlayer) {
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		if (hotspot.skinid=='hotspot') {
			...
			this._hsimage2__img.setAttribute('src','images/hsimage2.svg');
		...
		if (hotspot.skinid=='left') {
			...
			this._hsimage1__img.setAttribute('src','images/hsimage1.svg');
		...
		if (hotspot.skinid=='right') {
			...
			this._hsimage0__img.setAttribute('src','images/hsimage0.svg');
